...
/**
 * Test the getReferenceForPassageTest method.
 * Assumes BibleIO works and KJV.atv is correct.
 * The KJV bible is used for all the tests.

 * @author Jake Haitsma, Fred Ottensmeyer
 */
public class TestGetReferencesForPassage {
	...
	public void setUp() throws Exception {
		...
		VerseList copyOfVerseList = new VerseList(versesFromFile.getVersion(), versesFromFile.getDescription(), copyOfList);
	...
	public void testInvalidResultsInvalidParams() {
		...
		results = model.getReferencesForPassage("Mal 13:6-24:7");
		assertEquals(0, results.size());
	}
	...
	public void testValidResultsOddSyntax() {
		...
		actualResults = new VerseList("KJV", "KJV", versesFromFile.subList(29305, 29347));
		assertArrayEquals(actualResults.toArray(), verseResults.toArray());

		verseResults = getVersesForReference("Hebrews 11-12:2");
		actualResults = new VerseList("KJV", "KJV", versesFromFile.subList(30173, 30215));
		assertArrayEquals(actualResults.toArray(), verseResults.toArray());
	}
	...
	public void testValidResultsWholeBook() {
		...
		actualResults = new VerseList("KJV", "KJV", versesFromFile.subList(8718, 9534));
		assertArrayEquals(actualResults.toArray(), verseResults.toArray());

		verseResults = getVersesForReference("Philemon");
		actualResults = new VerseList("KJV", "KJV", versesFromFile.subList(29939, 29964));
		assertArrayEquals(actualResults.toArray(), verseResults.toArray());
	}
	...
	public void testValidResultsMultipleVersesAndChapters() {
		...
		actualResults = new VerseList("KJV", "KJV", versesFromFile.subList(18709, 18724));
		assertArrayEquals(actualResults.toArray(), verseResults.toArray());

		verseResults = getVersesForReference("Mal 3:6-4:6");
		actualResults = new VerseList("KJV", "KJV", versesFromFile.subList(23126, 23145));
		assertArrayEquals(actualResults.toArray(), verseResults.toArray());
	}
	...
	public void testValidResultsMultipleChapters() {
		...
		actualResults = new VerseList("KJV", "KJV", versesFromFile.subList(17572, 17583));
		assertArrayEquals(actualResults.toArray(), verseResults.toArray());

		verseResults = getVersesForReference("Revelation 22");
		actualResults = new VerseList("KJV", "KJV", versesFromFile.subList(31081, 31102));
		assertArrayEquals(actualResults.toArray(), verseResults.toArray());

		verseResults = getVersesForReference("1 Tim 2-4");
		actualResults = new VerseList("KJV", "KJV", versesFromFile.subList(29717, 29764));
		assertArrayEquals(actualResults.toArray(), verseResults.toArray());

		verseResults = getVersesForReference("1 John 2-3");
		actualResults = new VerseList("KJV", "KJV", versesFromFile.subList(30551, 30604));
		assertArrayEquals(actualResults.toArray(), verseResults.toArray());
	}
	...
	public void testValidResultsSingleChapter() {
		VerseList verseResults;
		VerseList actualResults;
		verseResults = getVersesForReference("Ecclesiastes 3 : 1 - 8");
		actualResults = new VerseList("KJV", "KJV", versesFromFile.subList(17360, 17368));
		assertArrayEquals(actualResults.toArray(), verseResults.toArray());

		verseResults = getVersesForReference("Joshua 24:28-33");
		actualResults = new VerseList("KJV", "KJV", versesFromFile.subList(6504, 6510));
		assertArrayEquals(actualResults.toArray(), verseResults.toArray());

		verseResults = getVersesForReference("Psalm 23:1-6");
		actualResults = new VerseList("KJV", "KJV", versesFromFile.subList(14236, 14242));
		assertArrayEquals(actualResults.toArray(), verseResults.toArray());
	}
	...
	/**
	 * A helper method to get a VerseList from getReferencesForPassage().
	 *
